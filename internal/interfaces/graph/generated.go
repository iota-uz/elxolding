...
type ComplexityRoot struct {
	Mutation struct {
		...
		AuthenticateWithUserID func(childComplexity int, userID int, password string) int
	}
...
type MutationResolver interface {
	...
	AuthenticateWithUserID(ctx context.Context, userID int, password string) (*model.Session, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.authenticateWithUserID":
		if e.complexity.Mutation.AuthenticateWithUserID == nil {
			break
		}

		args, err := ec.field_Mutation_authenticateWithUserID_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.AuthenticateWithUserID(childComplexity, args["userID"].(int), args["password"].(string)), true
...
//go:embed "auth.graphql" "base.graphql"
...
func (ec *executionContext) field_Mutation_authenticateWithUserID_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Mutation_authenticateWithUserID_argsUserID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["userID"] = arg0
	arg1, err := ec.field_Mutation_authenticateWithUserID_argsPassword(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["password"] = arg1
...
func (ec *executionContext) field_Mutation_authenticateWithUserID_argsUserID(
	ctx context.Context,
	rawArgs map[string]interface{},
) (int, error) {
	// We won't call the directive if the argument is null.
...
func (ec *executionContext) field_Mutation_authenticateWithUserID_argsPassword(
	ctx context.Context,
	rawArgs map[string]interface{},
) (string, error) {
	// We won't call the directive if the argument is null.
...
func (ec *executionContext) _Mutation_authenticateWithUserID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_authenticateWithUserID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AuthenticateWithUserID(rctx, fc.Args["userID"].(int), fc.Args["password"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_authenticateWithUserID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_authenticateWithUserID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "authenticateWithUserID":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_authenticateWithUserID(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
