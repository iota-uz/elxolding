...
<template>
    ...
    >
        ...
        >
            <span
                class="bg-[#091EA5] absolute block h-0.5 w-full transition-all duration-300"
                :class="[
            ...
            ></span>
            <span
                class="bg-[#091EA5] absolute top-1/2 block h-0.5 w-full max-w-[50%] transition-all duration-300"
                :class="[
